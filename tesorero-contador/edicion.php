        ...
        <div class="card-body">
            ...
            <?php $afiliado = $listaAfiliados  ?>
                ...
                <div class = "form-group">
                    ...
                    <input type="number" name="txtCI" class="form-control" readonly="readonly" id="txtCI" value="<?php echo $_GET["tabla1"] ?>" placeholder="Cédula de Identidad">
                </div>

                <div class = "form-group">
                    <label for="txtApe">Apellido(s)</label>
                    <input type="text" name="txtApe" class="form-control" readonly="readonly" id="txtApe" value="<?php echo $_GET["tabla2"] ?>" placeholder="Apellido(s)">
                </div>

                <div class = "form-group">
                    <label for="txtNombre">Nombre(s)</label>
                    <input type="text" name="txtNombre" class="form-control" readonly="readonly" id="txtNombre" placeholder="Nombre(s)" value="<?php echo $_GET["tabla3"] ?>">
                </div>
                <br><br><br>

                <div class = "form-group">
                    <label for="txtTrabajo">Unidad de Trabajo</label>
                    <input type="text" name="txtTrabajo" class="form-control" readonly="readonly" id="txtTrabajo" value="<?php echo $_GET["tabla4"] ?>" placeholder="Unidad de Trabajo">
                </div>

                <div class = "form-group">
                    <label for="txtNomina">Grupo de Nomina</label>
                    <input type="text" name="txtNomina" class="form-control" readonly="readonly" id="txtNomina" value="<?php echo $_GET["tabla5"] ?>">
                        <!-- <option  selected><?php echo $_GET["tabla5"] ?></option>                      
                    </select> -->
                ...
                <div class = "form-group">
                    ...
                    <input type="text" name="txtCuota" class="form-control" id="txtCuota" readonly="readonly" value="<?php echo $_GET["tabla6"] ?>%" placeholder="">
                </div>

                <div class = "form-group">
                    <label for="txtIngreso">Fecha de Incorporación</label>
                    <input type="date" name="txtIngreso" class="form-control" id="txtIngreso" readonly="readonly" value="<?php echo $_GET["tabla7"] ?>" placeholder="">
                </div>
                <br><br><br>
                <div class = "form-group">
                    <label for="txtSueldo">Sueldo</label>
                    <input type="text" name="txtSueldo" class="form-control" id="txtSueldo" readonly="readonly" value="<?php echo number_format($_GET["tabla11"], 2, "," , ".") ?>" placeholder="">
                </div>
                
                <div class = "form-group">
                    <label for="txtRetiro">Fecha de Retiro</label>
                    <input type="date" name="txtRetiro" class="form-control" id="txtRetiro" readonly="readonly" value="<?php echo $_GET["tabla8"] ?>" placeholder="">
                </div>
                <div class = "form-group">
                    <label for="txtDescuento">Suspender descuento</label>
                    <input type="text" name="txtDescuento" class="form-control" id="txtDescuento" readonly="readonly" value="<?php echo $_GET["tabla9"] ?>" placeholder="">
                </div>

                <div class = "form-group">
                    <label for="txtSaldo">Ahorro Actual Bs.</label>
                    <input type="text" name="txtSaldo" class="form-control" id="txtSaldo" readonly="readonly" value="<?php echo number_format($_GET["tabla10"], 2, "," , ".")?>" placeholder="">
                </div>
